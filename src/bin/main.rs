...
async fn main(spawner: Spawner) -> ! {
    ...
    /* initialize a global heap allocated using the 64kb of RAM that was reclaimed from the bootloader init */
    ...
    let display =
        display::setup_display(peripherals.I2C0, peripherals.GPIO3, peripherals.GPIO2)
            .await
